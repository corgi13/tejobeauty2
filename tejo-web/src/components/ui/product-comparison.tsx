                ...
                <AnimatePresence>
                  {flippedCards.has(product.id) && (
                    ...
                    >
                      ...
                      {/* Key Ingredients */}
                      <div>
                        <h5 className="font-medium text-onyx mb-2">Ključni sastojci:</h5>
        ...
        {selectedProductObjects.length === 2 && (
          ...
          >
            <div className="p-6 border-b border-gray-100">
              <h3 className="font-heading text-2xl font-semibold text-onyx">
                Detaljna usporedba
              </h3>
            </div>
              ...
              <table className="w-full">
                <thead>
                  <tr className="bg-gray-50">
                    <th className="py-4 px-4 text-left font-semibold text-onyx">Karakteristika</th>
                ...
                <tbody>
                  {Array.from({ length: Math.max(...selectedProductObjects.map(p => p.specifications.length)) }, (_, index) =>
                    renderSpecificationRow(
                      selectedProductObjects.map(p => p.specifications[index] || { name: '', value: '' }),
                      index
                    )
                  )}
                </tbody>
